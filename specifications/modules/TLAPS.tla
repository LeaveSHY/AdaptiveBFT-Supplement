...
\* Prefer Z3 for arithmetic obligations; this has been more stable than the
\* default SMT backend in repeated CI/gate runs.
SimpleArithmetic == TRUE (*{ by (prover:"z33") }*)
